...
const double modelsDatabase_f14[6144], const emxArray_real_T *activeFeatures,
const emxArray_boolean_T *activeMask, const boolean_T noiseMask[24], const double Hl[24],
const double Bl[24], double choices[1000], double scores[1000]);
#endif;
